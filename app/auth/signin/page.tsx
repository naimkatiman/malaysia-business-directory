...
export default function SignInPage() {
  ...
  const handleSignInWithFacebook = async () => {
    ...
    try {
      ...
      setError(error.message || "An error occurred during sign in with Facebook")
      setLoading(false)
    }
  }
          ...
          <TabsContent value="social">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Sign in with your social media account</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {error && <div className="bg-destructive/15 text-destructive text-sm p-2 rounded-md">{error}</div>}
                ...
                <Button variant="outline" className="w-full" onClick={handleSignInWithFacebook} disabled={loading}>
                  <svg
